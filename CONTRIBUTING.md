...
Use [Ruff](https://docs.astral.sh/ruff/) to format and lint the code.

## Test your code modification

This custom component uses the project structure from the [integration_blueprint template](https://github.com/ludeeus/integration_blueprint).

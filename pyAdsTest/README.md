...
```
Route added to PLC1 (192.0.2.10)
Route added to PLC2 (192.0.2.11)
Route added to PLC3 (192.0.2.12)
Local AMS: 192.0.2.92.1.1
Connected to PLC1 (192.0.2.10)
Connected to PLC2 (192.0.2.11)
Connected to PLC3 (192.0.2.12)
Press 'q' + Enter to quit.
[STATE CHANGE] PLC1: None -> (AdsState.RUN, 0)
[STATE CHANGE] PLC2: None -> (AdsState.RUN, 0)
[STATE CHANGE] PLC3: None -> (AdsState.RUN, 0)
[PLC3 Variable] MAIN.Temperature = 23.45
[PLC3 Variable] MAIN.Output = 67.89
```
...
config = PLCConfig('MyPLC', '192.0.2.10', '192.0.2.10.1.1', '192.0.2.10')
